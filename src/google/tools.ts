...
function registerExecutors(registry: ToolRegistry): void {
  ...
  const wrap = (toolName: string, fn: () => Promise<string>) => {
    return async () => {
      const { getGoogleAuthClient, getServiceForTool, getGoogleServicesConfig } = await import('./auth.js');
  ...
  const getAuth = async () => {
    const { getGoogleAuthClient } = await import('./auth.js');
    return (await getGoogleAuthClient())!;
  };

  // Gmail
  safe('gmail_list', async (args) => {
    const { gmailList } = await import('./gmail.js');
  ...
  safe('gmail_search', async (args) => {
    const { gmailSearch } = await import('./gmail.js');
  ...
  safe('drive_search', async (args) => {
    const { driveSearch } = await import('./drive.js');
  ...
  safe('drive_download', async (args) => {
    const { driveDownload } = await import('./drive.js');
  ...
  safe('drive_share', async (args) => {
    const { driveShare } = await import('./drive.js');
  ...
  safe('drive_create_folder', async (args) => {
    const { driveCreateFolder } = await import('./drive.js');
  ...
  safe('sheets_write', async (args) => {
    const { sheetsWrite } = await import('./sheets.js');
    let values: string[][];
  ...
  safe('google_contacts_list', async (args) => {
    const { contactsList } = await import('./contacts.js');
  ...
  safe('google_contacts_search', async (args) => {
    const { contactsSearch } = await import('./contacts.js');
  ...
  safe('google_contacts_create', async (args) => {
    const { contactsCreate } = await import('./contacts.js');
  ...
  safe('gcal_list_events', async (args) => {
    const { calendarListEvents } = await import('./calendar.js');
  ...
  safe('gcal_create_event', async (args) => {
    const { calendarCreateEvent } = await import('./calendar.js');
  ...
  safe('gcal_update_event', async (args) => {
    const { calendarUpdateEvent } = await import('./calendar.js');
  ...
  registry.register('google_auth_status', async () => {
    try {
      const { getGoogleAuthStatus } = await import('./auth.js');
